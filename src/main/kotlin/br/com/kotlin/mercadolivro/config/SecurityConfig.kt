...
class SecurityConfig(
    ...
    override fun configure(http: HttpSecurity) {
       ...
       http.authorizeRequests()
        ...
        http.addFilter(AuthorizationFilter(authenticationManager(), userCustomDetails, jwtUtil))
